...
class LSTM_model(Model):
    ...
    def __init__(self, sess, emb_dim, rnn_units, hidden_layers, alpha, 
        ...
        with tf.compat.v1.variable_scope(self.scope):
            ...
            self.C_Basket = tf.compat.v1.get_variable(dtype=tf.float32, initializer=tf.constant(0.02), name="C_B") #beta = 0.02 which is the threshold for relu_with_threshold function
            ...
            with tf.compat.v1.name_scope("Basket_Sequence_Encoder"):
                ...
                rnn_encoder = create_rnn_encoder(self.bseq_encoder, self.rnn_units, self.hidden_layers, rnn_dropout_rate, self.bseq_length, rnn_cell_type, 
            ...
            with tf.name_scope("Loss"):
                ...
                self.top_k_values, self.top_k_indices = tf.nn.top_k(self.predictions, 300)
                #print("Something")
